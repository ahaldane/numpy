...
instead of a copy is pushed back to 1.16. For more information on how to
update code to account for this future change see "basics/structured
arrays/accessing multiple fields" in the user guide.
