...
.. warning::
   ...
   You can test the Numpy 1.15 behavior by setting
   ``np.multifield_index_view = True``. This option is for temporary testing
   purposes only, do not depend on its existence.
