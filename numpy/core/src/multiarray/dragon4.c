 ...
 *
 *     >>> from numpy.core.multiarray_tests import format_float_OSprintf_g
...
Dragon4_PrintFloat_IBM_double_double(
    char *buffer, npy_uint32 bufferSize, FloatVal128 val128,
    Dragon4_Options *opt)
{
    ...
    Dragon4_Options *opt)
{
    ...
    return Dragon4_PrintFloat_IBM_double_double(buffer, bufferSize, val128, opt);
}
